// MarkerInfoCard — rr-local card shown when the project marker is opened.
// Mirrors /selected's terra ProjectCard as initial content; route-owned so copy
...
export default function MarkerInfoCard() {
  return (
    <div className="rr-marker-info-card">
      <div className="rr-marker-info-card__illus" aria-hidden="true">
      ...
      <h3 className="rr-marker-info-card__title">
        A 5-minute game, with a simple mechanic
      </h3>
      <p className="rr-marker-info-card__body">
